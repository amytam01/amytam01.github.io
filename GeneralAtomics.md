...
**Description:** In Summer 2020, I moved to San Diego to start my journey as a software engineering intern on the Army Modernization team at GA-ASI. Despite COVID-19, I was working on-site due to the sensitivity of the information I was handling. By the end of my internship, I had gained powerful skills in unit testing and C/C++ knowledge while using Jenkins, LINUX, and Vim. This [GA-ASI Presentation](/pdf/AmyGA86.pdf) is the culmination of my work at GA-ASI.
